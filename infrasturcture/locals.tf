locals {
  ...
  airflow_dag_vars      = try(local.raw_settings.airflow.dagVars, "{\"env_mode\": \"prod\", \"airflow_home_dir\": \"/opt/airflow\", \"airflow_output\": \"/opt/airflow/output\", \"gcp_conn_id\": \"de\", \"dbt_bin\": \"/opt/airflow/.local/bin/dbt\", \"dbt_project_dir\": \"/opt/airflow/p2p\", \"dbt_profiles_dir\": \"/opt/airflow/.dbt\", \"bq_dataset\": \"mbelt3_raw_data\",  \"bq_project_id\": \"${local.project}\"}")
